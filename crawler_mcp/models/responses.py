"""
Custom response models for the optimized crawler.

Wrapper classes that extend Crawl4AI's AsyncCrawlResponse to include
additional attributes expected by tests and downstream consumers.
"""
